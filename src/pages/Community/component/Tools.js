...
function Tools() {
    return (
      ...
      <AnchorLink href="#Dicuss-Page" className="btn-viewer d-block text-center text-decoration-none" title="查看你的日常發文" >
      ...
      <AnchorLink href="#Post-Page" className="btn-poster d-block text-center text-decoration-none" title="寫個日記吧">
