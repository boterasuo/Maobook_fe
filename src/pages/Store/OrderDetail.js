            ...
            <section className='orderdetailArea p-2'>
                ...
                <form className='maildetail d-flex  flex-column ' >
                    ...
                    <label className='maillabel'>
                        宅配地址
                        <input className='mailinput' type="text" placeholder='新北市XX區XX路XX號' />
                    </label>
                    <label className='maillabel'>
                        支付方式
                    ...
                    <label className='maillabel'>
                        E-mail
                        <input className='mailinput' type="text" placeholder='test@test.com' />
                    </label>
                </form>
            </section>

            <div><img className='order-arrow' src={arrow} alt="arrow" /></div>
            <div className='d-flex justify-content-center mt-2 mb-5' >
                <Button className='checkoutBtn' variant="primary"><img className='pr-2' src={money} alt="money" />結帳</Button>
            </div>
