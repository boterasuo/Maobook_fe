            ...
            <div className="schedulePostTag1">
              ...
              {/* 選擇寵物 */}
                <select 
                  ...
                  aria-haspopup="true" 
                  aria-expanded="false">
                  <option value="小喵" className="dropdown-item">小喵</option>
                  <option value="布魯托" className="dropdown-item">布魯托</option>
                  <option value="唐基柯德" className="dropdown-item">唐基柯德</option>
                </select>
              </div>
              {/* 輸入TAG標籤 */}
              <div>
            ...
            <fieldset id="category">
                <label for="a" className="scheduleButIcon1 lg">
                  <input 
                    ...
                    className="schedulePostCircle"/>
                  <span className="schedulePostTagtext">疫苗<br/>保健</span>
                </label>
                ...
                <label for="2" className="scheduleButIcon2 lg">
                  <input 
                    ...
                    onChange={(e) => {setEventTag(e.target.value)}}
                    className="schedulePostCircle"/>
                  <span className="schedulePostTagtext">定期<br/>美容</span>
                </label>
                ...
                <label for="3" className="scheduleButIcon3 lg">
                  <input 
                    ...
                    onChange={(e) => {setEventTag(e.target.value)}}
                    className="schedulePostCircle"/>
                  <span className="schedulePostTagtext">補貨<br/>罐罐</span>
                </label>
                ...
                <label for="4" className="scheduleButIcon4 lg">
                  <input 
                    ...
                    onChange={(e) => {setEventTag(e.target.value)}}
                    className="schedulePostCircle"/>
                  <span className="schedulePostTagtext">紀錄<br/>提醒</span>
                </label>
              </fieldset>
